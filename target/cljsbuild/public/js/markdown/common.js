...
var len__4499__auto___6157 = arguments.length;
var i__4500__auto___6158 = (0);
while(true){
if((i__4500__auto___6158 < len__4499__auto___6157)){
args__4502__auto__.push((arguments[i__4500__auto___6158]));

var G__6159 = (i__4500__auto___6158 + (1));
i__4500__auto___6158 = G__6159;
continue;
} else {
}
break;
...
/** @this {Function} */
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq6156){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq6156));
});
...
var G__6162 = cljs.core.reduce.call(null,((function (text,state,matches,temp__5455__auto__){
return (function (s,r){
...
return cljs.core.get.call(null,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__6160_SHARP_,p1__6160_SHARP_);
});})(text,state,matches,temp__5455__auto__))
);
});})(text,state,matches,temp__5455__auto__))
,text,matches);
var G__6163 = cljs.core.update.call(null,state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5455__auto__){
return (function (p1__6161_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__6161_SHARP_,matches);
});})(text,state,matches,temp__5455__auto__))
);
text = G__6162;
state = G__6163;
...
var vec__6166 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__6169 = transformer.call(null,clojure.string.join.call(null,buf),cur_state);
var s = cljs.core.nth.call(null,vec__6169,(0),null);
var new_state = cljs.core.nth.call(null,vec__6169,(1),null);
...
var new_buf = cljs.core.nth.call(null,vec__6166,(0),null);
var new_state = cljs.core.nth.call(null,vec__6166,(1),null);
var G__6173 = cljs.core.vec.call(null,cljs.core.concat.call(null,out,cljs.core.seq.call(null,open),new_buf,cljs.core.seq.call(null,close)));
var G__6174 = cljs.core.PersistentVector.EMPTY;
var G__6175 = cljs.core.rest.call(null,tokens);
var G__6176 = cljs.core.assoc.call(null,new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__6173;
buf = G__6174;
tokens = G__6175;
cur_state = G__6176;
...
var G__6177 = out;
var G__6178 = cljs.core.into.call(null,buf,cljs.core.first.call(null,tokens));
var G__6179 = cljs.core.rest.call(null,tokens);
var G__6180 = cur_state;
out = G__6177;
buf = G__6178;
tokens = G__6179;
cur_state = G__6180;
...
var G__6181 = out;
var G__6182 = buf;
var G__6183 = cljs.core.rest.call(null,tokens);
var G__6184 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__6181;
buf = G__6182;
tokens = G__6183;
cur_state = G__6184;
...
var G__6185 = cljs.core.into.call(null,out,cljs.core.first.call(null,tokens));
var G__6186 = buf;
var G__6187 = cljs.core.rest.call(null,tokens);
var G__6188 = cur_state;
out = G__6185;
buf = G__6186;
tokens = G__6187;
cur_state = G__6188;
...
var num_hashes = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__6189_SHARP_){
return cljs.core.not_EQ_.call(null," ",p1__6189_SHARP_);
}),cljs.core.take_while.call(null,(function (p1__6190_SHARP_){
return ((cljs.core._EQ_.call(null,"#",p1__6190_SHARP_)) || (cljs.core._EQ_.call(null," ",p1__6190_SHARP_)));
