...
var G__6078 = format;
var G__6078__$1 = (((G__6078 instanceof cljs.core.Keyword))?G__6078.fqn:null);
switch (G__6078__$1) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__6082_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__6082_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__6083){
...
var handler = cljs.core.get.call(null,map__6084__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__6084__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__6084__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return ((function (h,e,map__6084,map__6084__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__6086){
var vec__6087 = p__6086;
var ok = cljs.core.nth.call(null,vec__6087,(0),null);
var result = cljs.core.nth.call(null,vec__6087,(1),null);
...
;})(h,e,map__6084,map__6084__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__6090){
var map__6091 = p__6090;
var map__6091__$1 = ((((!((map__6091 == null)))?(((((map__6091.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6091.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6091):map__6091);
var opts = map__6091__$1;
var method = cljs.core.get.call(null,map__6091__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__6091__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__6091__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__6091__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__6091__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
