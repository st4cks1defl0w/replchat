...
var o45073 = temp__5455__auto__;
var temp__5455__auto____$1 = (o45073["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o45074 = temp__5455__auto____$1;
return (o45074["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__44183__auto__ = f;
return (o__44183__auto__["toString"]).call(o__44183__auto__);
} else {
return "";
}
}catch (e45075){var _ = e45075;
return "";
}});
...
try{var o__44183__auto___45077 = t;
(o__44183__auto___45077["cljs$lang$ctorPrWriter"]).call(o__44183__auto___45077,t,writer);
}catch (e45076){var __45078 = e45076;
}
...
var char_code = (function (){var o__44183__auto__ = (new String(char$));
return (o__44183__auto__["charCodeAt"]).call(o__44183__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__44183__auto__ = String;
return (o__44183__auto__["fromCharCode"]).call(o__44183__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__45079 = num_code;
switch (G__45079) {
case (1):
return (185);
...
var o__44183__auto__ = String;
return (o__44183__auto__["fromCharCode"]).call(o__44183__auto__,superscript_code);
});
/**
...
}catch (e45081){var _e__44190__auto__ = e45081;
return false;
}})())){
...
var vec__45082 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__45082,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o45085 = temp__5455__auto__;
var temp__5455__auto____$1 = (o45085["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o45086 = temp__5455__auto____$1;
return (o45086["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___45093 = arguments.length;
var i__4500__auto___45094 = (0);
while(true){
if((i__4500__auto___45094 < len__4499__auto___45093)){
args__4502__auto__.push((arguments[i__4500__auto___45094]));

var G__45095 = (i__4500__auto___45094 + (1));
i__4500__auto___45094 = G__45095;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__45089){
var vec__45090 = p__45089;
var ns_detector = cljs.core.nth.call(null,vec__45090,(0),null);
...
var G__45096 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__45097 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__45096;
remaining_tokens = G__45097;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq45087){
var G__45088 = cljs.core.first.call(null,seq45087);
var seq45087__$1 = cljs.core.next.call(null,seq45087);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45088,seq45087__$1);
});
...
var vec__45101 = cljs.core.split_with.call(null,(function (p1__45100_SHARP_){
return cljs.core.not_EQ_.call(null,p1__45100_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__45101,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__45101,(1),null);
...
var vec__45104 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__45104,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__45104,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__45107 = cljs.core.rest.call(null,remaining_tokens);
var G__45108 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__45107;
name_tokens = G__45108;
continue;
} else {
...
var vec__45111 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__45111,(0),null);
var arity = cljs.core.nth.call(null,vec__45111,(1),null);
var vec__45114 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__45114,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__45114,(1),null);
var vec__45117 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__45117,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__45117,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__45117,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__45117,(3),null);
...
var vec__45123 = result;
var munged_ns = cljs.core.nth.call(null,vec__45123,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__45123,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__45123,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__45123,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__45123,(4),null);
var arity = cljs.core.nth.call(null,vec__45123,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__45127 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__45127,(0),null);
var args = cljs.core.nth.call(null,vec__45127,(1),null);
var vec__45130 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__45130,(0),null);
var name = cljs.core.nth.call(null,vec__45130,(1),null);
...
var G__45133 = (arity + (1));
var G__45134 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__45135){
var vec__45136 = p__45135;
var arity = cljs.core.nth.call(null,vec__45136,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__45136,(1),null);
...
return cljs.core.get.call(null,arities,p1__45139_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__45140_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__45143){
var vec__45144 = p__45143;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__45144,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq45141){
var G__45142 = cljs.core.first.call(null,seq45141);
var seq45141__$1 = cljs.core.next.call(null,seq45141);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45142,seq45141__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__45152__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__45152__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__45152__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__45152__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__45153 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__45153,(0),null);
var fn_name = cljs.core.nth.call(null,vec__45153,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__45153,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__45153,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__45153,(4),null);
var arity = cljs.core.nth.call(null,vec__45153,(5),null);
...
var o__44183__auto__ = f;
return (o__44183__auto__["getBasis"]).call(o__44183__auto__);
});
/**
...
}catch (e45157){var _e__44190__auto__ = e45157;
...
var G__45158 = (obj[cljs.core.first.call(null,path)]);
var G__45159 = cljs.core.rest.call(null,path);
obj = G__45158;
path = G__45159;
continue;
} else {
...
return (function (accum,p__45160){
var vec__45161 = p__45160;
var bit = cljs.core.nth.call(null,vec__45161,(0),null);
var protocol = cljs.core.nth.call(null,vec__45161,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__45164){
var vec__45165 = p__45164;
var ns = cljs.core.nth.call(null,vec__45165,(0),null);
var name = cljs.core.nth.call(null,vec__45165,(1),null);
var selector = cljs.core.nth.call(null,vec__45165,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__45170,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__45170,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__45170,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__45168_SHARP_){
return (obj[cljs.core.first.call(null,p1__45168_SHARP_)]);
});})(name,sorted_matches,vec__45170,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1536503757851
