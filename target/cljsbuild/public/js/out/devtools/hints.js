...
var map__51008 = top_item;
var map__51008__$1 = ((((!((map__51008 == null)))?(((((map__51008.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51008.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51008):map__51008);
var file = cljs.core.get.call(null,map__51008__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__51008__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__51008__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e51007){var _e = e51007;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___51010 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___51010)){
var seen_errors_51011 = temp__5455__auto___51010;
if(cljs.core.truth_(seen_errors_51011.has(self))){
} else {
seen_errors_51011.add(self);

var temp__5457__auto___51012 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___51012)){
var sense_51013 = temp__5457__auto___51012;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_51013)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1536503778483
