...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__53566_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__53566_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__53566_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__53567){
var vec__53568 = p__53567;
var low = cljs.core.nth.call(null,vec__53568,(0),null);
var high = cljs.core.nth.call(null,vec__53568,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__53571,s,color,element,idx){
...
var style_map = cljs.core.get.call(null,map__53572__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__53572__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__53572__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__53574){
var vec__53575 = p__53574;
var s = cljs.core.nth.call(null,vec__53575,(0),null);
var style = cljs.core.nth.call(null,vec__53575,(1),null);
var start = cljs.core.nth.call(null,vec__53575,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__53578){
var vec__53579 = p__53578;
var s = cljs.core.nth.call(null,vec__53579,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__53579,(1),null);
var element = cljs.core.nth.call(null,vec__53579,(2),null);
...
var G__53582 = cljs.core.next.call(null,ssv);
var G__53583 = (this_ssv == null);
var G__53584 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__53585 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && (!((this_ssv == null)))))?cljs.core.conj.call(null,cljs.core.conj.call(null,cljs.core.conj.call(null,out,zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.call(null,out,this_ssv)
)));
ssv = G__53582;
doing_nil_QMARK_ = G__53583;
last_elide = G__53584;
out = G__53585;
continue;
}
...
var vec__53586 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__53586,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__53586,(1),null);
var element_type = cljs.core.nth.call(null,vec__53586,(2),null);
...
var G__53589 = cljs.core.next.call(null,remaining_cvec);
var G__53590 = new_idx;
var G__53591 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__53589;
idx = G__53590;
out = G__53591;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__53602,cursor_vec){
var vec__53603 = p__53602;
var focus_start = cljs.core.nth.call(null,vec__53603,(0),null);
var focus_end = cljs.core.nth.call(null,vec__53603,(1),null);
var focus_vec = vec__53603;
...
var vec__53606 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__53606,(0),null);
var back = cljs.core.nth.call(null,vec__53606,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__53609){
var vec__53610 = p__53609;
var s = cljs.core.nth.call(null,vec__53610,(0),null);
var color = cljs.core.nth.call(null,vec__53610,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__53616,existing_count){
var vec__53617 = p__53616;
var s = cljs.core.nth.call(null,vec__53617,(0),null);
var cursor = cljs.core.nth.call(null,vec__53617,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__53617,s,cursor){
return (function (p1__53613_SHARP_){
return !(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__53613_SHARP_)));
});})(s__$1,len,cursor__$1,vec__53617,s,cursor))
...
var vec__53621 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__53621,(0),null);
var where = cljs.core.nth.call(null,vec__53621,(1),null);
var cvec_element = vec__53621;
if((cvec_element == null)){
var G__53624 = cljs.core.next.call(null,cvec_nl);
var G__53625 = (idx + (1));
var G__53626 = start;
var G__53627 = out;
cvec_nl = G__53624;
...
var G__53628 = cljs.core.next.call(null,cvec_nl);
var G__53629 = (idx + (1));
var G__53630 = idx;
var G__53631 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__53628;
idx = G__53629;
start = G__53630;
out = G__53631;
...
var G__53632 = cljs.core.next.call(null,cvec_nl);
var G__53633 = (idx + (1));
var G__53634 = (idx + (1));
var G__53635 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__53632;
idx = G__53633;
start = G__53634;
out = G__53635;
...
var G__53636 = cljs.core.next.call(null,cvec_nl);
var G__53637 = (idx + (1));
var G__53638 = idx;
var G__53639 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__53636;
idx = G__53637;
start = G__53638;
out = G__53639;
...
var G__53640 = cljs.core.next.call(null,cvec_nl);
var G__53641 = (idx + (1));
var G__53642 = start;
var G__53643 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__53640;
idx = G__53641;
start = G__53642;
out = G__53643;
...
return cljs.core.reduce.call(null,(function (p1__53645_SHARP_,p2__53644_SHARP_){
if(cljs.core.truth_(zprint.finish.within_QMARK_.call(null,idx,p2__53644_SHARP_))){
return cljs.core.reduced.call(null,p1__53645_SHARP_);
} else {
return (p1__53645_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__53646,p__53647){
var vec__53648 = p__53646;
var focus_begin = cljs.core.nth.call(null,vec__53648,(0),null);
var focus_end = cljs.core.nth.call(null,vec__53648,(1),null);
var vec__53651 = p__53647;
var before = cljs.core.nth.call(null,vec__53651,(0),null);
var after = cljs.core.nth.call(null,vec__53651,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__53655,cvec,focus_vec){
var map__53656 = p__53655;
var map__53656__$1 = ((((!((map__53656 == null)))?(((((map__53656.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53656.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53656):map__53656);
var options = map__53656__$1;
var map__53657 = cljs.core.get.call(null,map__53656__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__53657__$1 = ((((!((map__53657 == null)))?(((((map__53657.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53657.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53657):map__53657);
var focus = cljs.core.get.call(null,map__53657__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__53657__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__53657__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__53656,map__53656__$1,options,map__53657,map__53657__$1,focus,lines,paths){
return (function (p1__53654_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__53654_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__53656,map__53656__$1,options,map__53657,map__53657__$1,focus,lines,paths))
,path_vecs);
...
//# sourceMappingURL=finish.js.map?rel=1536503794088
