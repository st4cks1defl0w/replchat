...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__44154 = cljs.core.instance_QMARK_;
var expr__44155 = reactive_val;
if(cljs.core.truth_(pred__44154.call(null,reagent.ratom.RAtom,expr__44155))){
return "ra";
} else {
if(cljs.core.truth_(pred__44154.call(null,reagent.ratom.RCursor,expr__44155))){
return "rc";
} else {
if(cljs.core.truth_(pred__44154.call(null,reagent.ratom.Reaction,expr__44155))){
return "rx";
} else {
if(cljs.core.truth_(pred__44154.call(null,reagent.ratom.Track,expr__44155))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1536503755151
