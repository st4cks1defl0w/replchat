 ...
 */
mranderson048.garden.v1v3v3.garden.compression.token_fn = (function mranderson048$garden$v1v3v3$garden$compression$token_fn(p__55612){
var vec__55613 = p__55612;
var tag = cljs.core.nth.call(null,vec__55613,(0),null);
var re = cljs.core.nth.call(null,vec__55613,(1),null);
return ((function (vec__55613,tag,re){
return (function (s){
...
var len__4499__auto___55618 = arguments.length;
var i__4500__auto___55619 = (0);
while(true){
if((i__4500__auto___55619 < len__4499__auto___55618)){
args__4502__auto__.push((arguments[i__4500__auto___55619]));

var G__55620 = (i__4500__auto___55619 + (1));
i__4500__auto___55619 = G__55620;
continue;
} else {
}
break;
...
return (function (p1__55616_SHARP_){
return p1__55616_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
/** @this {Function} */
mranderson048.garden.v1v3v3.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq55617){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq55617));
});
...
var map__55621 = temp__5455__auto__;
...
var tag = cljs.core.get.call(null,map__55621__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__55621__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__55621__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__55624 = cljs.core.subs.call(null,s1,size);
var G__55625 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s2),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__55623 = tag;
...
//# sourceMappingURL=compression.js.map?rel=1536503805104
