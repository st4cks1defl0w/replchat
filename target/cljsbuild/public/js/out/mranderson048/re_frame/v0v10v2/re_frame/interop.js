...
mranderson048.re_frame.v0v10v2.re_frame.interop.after_render = mranderson048.reagent.v0v8v0.reagent.core.after_render;
/**
 * @define {boolean}
 */
...
return mranderson048.reagent.v0v8v0.reagent.core.atom.call(null,x);
});
...
return cljs.core.native_satisfies_QMARK_.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.IReactiveAtom,x);
} else {
return false;
}
}
...
return mranderson048.reagent.v0v8v0.reagent.ratom.make_reaction.call(null,f);
});
...
return mranderson048.reagent.v0v8v0.reagent.ratom.add_on_dispose_BANG_.call(null,a_ratom,f);
});
...
return mranderson048.reagent.v0v8v0.reagent.ratom.dispose_BANG_.call(null,a_ratom);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__52519 = cljs.core.instance_QMARK_;
var expr__52520 = reactive_val;
if(cljs.core.truth_(pred__52519.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__52520))){
return "ra";
} else {
if(cljs.core.truth_(pred__52519.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__52520))){
return "rc";
} else {
if(cljs.core.truth_(pred__52519.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__52520))){
return "rx";
} else {
if(cljs.core.truth_(pred__52519.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__52520))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1536503789169
