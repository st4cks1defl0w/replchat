...
if((i < len)){
var k = (ks[i]);
var G__52315 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__52316 = (i + (1));
m = G__52315;
i = G__52316;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__52318 = c;
var G__52318__$1 = (((G__52318 == null))?null:G__52318.prototype);
if((G__52318__$1 == null)){
return null;
} else {
return (G__52318__$1["reagentRender"]);
}
})() == null))));
});
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__52320 = c;
var G__52320__$1 = (((G__52320 == null))?null:G__52320.prototype);
if((G__52320__$1 == null)){
return null;
} else {
return (G__52320__$1["render"]);
}
})() == null))));
});
...
if(typeof mranderson048.reagent.v0v8v0.reagent.impl.component.as_element !== 'undefined'){
} else {
...
return (function() { 
var G__52323__delegate = function (args){
...
var G__52323 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__52324__i = 0, G__52324__a = new Array(arguments.length -  0);
while (G__52324__i < G__52324__a.length) {G__52324__a[G__52324__i] = arguments[G__52324__i + 0]; ++G__52324__i;}
  args = new cljs.core.IndexedSeq(G__52324__a,0,null);
} 
return G__52323__delegate.call(this,args);};
G__52323.cljs$lang$maxFixedArity = 0;
G__52323.cljs$lang$applyTo = (function (arglist__52325){
var args = cljs.core.seq(arglist__52325);
return G__52323__delegate(args);
});
G__52323.cljs$core$IFn$_invoke$arity$variadic = G__52323__delegate;
return G__52323;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR_52327 = mranderson048.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_;
mranderson048.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_ = c;
...
(cljs.core.truth_(mranderson048.reagent.v0v8v0.reagent.debug.tracking)?mranderson048.reagent.v0v8v0.reagent.debug.track_console:console).error([cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Error rendering component",cljs.core.str.cljs$core$IFn$_invoke$arity$1(mranderson048.reagent.v0v8v0.reagent.impl.component.comp_name.call(null))].join(''))].join(''));
} else {
}
}
}
}finally {mranderson048.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_52327;
}});
...
return ((function (G__52328,G__52328__$1){
...
var or__3922__auto__ = mranderson048.reagent.v0v8v0.reagent.impl.util._STAR_always_update_STAR_;
if(or__3922__auto__){
...
var c = this;
var G__52329_52331 = (c["cljsRatom"]);
if((G__52329_52331 == null)){
} else {
mranderson048.reagent.v0v8v0.reagent.ratom.dispose_BANG_.call(null,G__52329_52331);
}
...
var renders_52333 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_52334 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_52333));
if((cljs.core.count.call(null,renders_52333) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_52333))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_52334)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_52334))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__52332 = name;
switch (G__52332) {
case "":
...
var G__52336 = o;
(G__52336[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__52337 = fiber;
var G__52337__$1 = (((G__52337 == null))?null:(G__52337["type"]));
if((G__52337__$1 == null)){
return null;
} else {
return (G__52337__$1["displayName"]);
}
})();
var parent = (function (){var G__52338 = fiber;
if((G__52338 == null)){
return null;
} else {
return (G__52338["return"]);
}
})();
var path = (function (){var G__52339 = parent;
var G__52339__$1 = (((G__52339 == null))?null:mranderson048.reagent.v0v8v0.reagent.impl.component.fiber_component_path.call(null,G__52339));
if((G__52339__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52339__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__52341 = c;
if((G__52341 == null)){
return null;
} else {
return (G__52341["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__52342._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__52344 = c;
if((G__52344 == null)){
return null;
} else {
return (G__52344["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__52346 = c;
if((G__52346 == null)){
return null;
} else {
return G__52346._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__52348 = instance;
if((G__52348 == null)){
return null;
} else {
return (G__52348["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__52349 = instance;
if((G__52349 == null)){
return null;
} else {
return G__52349._currentElement;
}
}
})();
var name = (function (){var G__52350 = elem;
var G__52350__$1 = (((G__52350 == null))?null:(G__52350["type"]));
if((G__52350__$1 == null)){
return null;
} else {
return (G__52350__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__52352 = elem;
if((G__52352 == null)){
return null;
} else {
return (G__52352["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__52353._owner;
}
}
})();
var path = (function (){var G__52354 = owner;
var G__52354__$1 = (((G__52354 == null))?null:mranderson048.reagent.v0v8v0.reagent.impl.component.component_path.call(null,G__52354));
if((G__52354__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52354__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var n = (function (){var or__3922__auto__ = mranderson048.reagent.v0v8v0.reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__52355 = c;
var G__52355__$1 = (((G__52355 == null))?null:G__52355.constructor);
if((G__52355__$1 == null)){
return null;
} else {
return mranderson048.reagent.v0v8v0.reagent.impl.util.fun_name.call(null,G__52355__$1);
}
}
})();
...
var temp__5459__auto__ = mranderson048.reagent.v0v8v0.reagent.impl.component.cached_react_class.call(null,tag);
if((temp__5459__auto__ == null)){
...
//# sourceMappingURL=component.js.map?rel=1536503788221
