...
struct.core.dissoc_in = (function struct$core$dissoc_in(m,p__51558){
var vec__51559 = p__51558;
var seq__51560 = cljs.core.seq.call(null,vec__51559);
var first__51561 = cljs.core.first.call(null,seq__51560);
var seq__51560__$1 = cljs.core.next.call(null,seq__51560);
var k = first__51561;
var ks = seq__51560__$1;
var keys = vec__51559;
if(ks){
...
return cljs.core.reduce.call(null,(function (p1__51562_SHARP_,p2__51563_SHARP_){
return cljs.core.conj_BANG_.call(null,p1__51562_SHARP_,struct.core.build_step.call(null,key,p2__51563_SHARP_));
}),acc,value);
} else {
return cljs.core.conj_BANG_.call(null,acc,struct.core.build_step.call(null,key,value));
}
});
struct.core.normalize_step_entry = (function struct$core$normalize_step_entry(acc,p__51566){
...
var key = first__51569;
var values = seq__51568__$1;
return cljs.core.reduce.call(null,((function (vec__51567,seq__51568,first__51569,seq__51568__$1,key,values){
return (function (p1__51564_SHARP_,p2__51565_SHARP_){
return cljs.core.conj_BANG_.call(null,p1__51564_SHARP_,struct.core.build_step.call(null,key,p2__51565_SHARP_));
});})(vec__51567,seq__51568,first__51569,seq__51568__$1,key,values))
,acc,values);
});
...
var G__51570 = skip;
var G__51571 = errors;
var G__51572 = data__$1;
var G__51573 = cljs.core.rest.call(null,steps__$1);
skip = G__51570;
errors = G__51571;
data__$1 = G__51572;
steps__$1 = G__51573;
...
var G__51574 = skip;
var G__51575 = errors;
var G__51576 = data__$1;
var G__51577 = cljs.core.rest.call(null,steps__$1);
skip = G__51574;
errors = G__51575;
data__$1 = G__51576;
steps__$1 = G__51577;
...
var G__51578 = skip;
var G__51579 = errors;
var G__51580 = cljs.core.assoc_in.call(null,data__$1,path,value__$1);
var G__51581 = cljs.core.rest.call(null,steps__$1);
skip = G__51578;
errors = G__51579;
data__$1 = G__51580;
steps__$1 = G__51581;
...
var G__51582 = cljs.core.conj.call(null,skip,path);
var G__51583 = cljs.core.assoc_in.call(null,errors,path,message);
var G__51584 = struct.core.dissoc_in.call(null,data__$1,path);
var G__51585 = cljs.core.rest.call(null,steps__$1);
skip = G__51582;
errors = G__51583;
data__$1 = G__51584;
steps__$1 = G__51585;
...
struct.core.validate.cljs$core$IFn$_invoke$arity$3 = (function (data,schema,p__51588){
var map__51589 = p__51588;
var map__51589__$1 = ((((!((map__51589 == null)))?(((((map__51589.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51589.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51589):map__51589);
var opts = map__51589__$1;
var strip = cljs.core.get.call(null,map__51589__$1,new cljs.core.Keyword(null,"strip","strip",632627960),false);
...
struct.core.validate_BANG_.cljs$core$IFn$_invoke$arity$3 = (function (data,schema,p__51597){
...
var opts = map__51598__$1;
var message = cljs.core.get.call(null,map__51598__$1,new cljs.core.Keyword(null,"message","message",-406056002),"Schema validation error");
var vec__51600 = struct.core.validate.call(null,data,schema,opts);
var errors = cljs.core.nth.call(null,vec__51600,(0),null);
var data__$1 = cljs.core.nth.call(null,vec__51600,(1),null);
...
struct.core.uuid = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"must be an uuid",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__51605_SHARP_){
return (p1__51605_SHARP_ instanceof cljs.core.UUID);
})], null);
struct.core._PLUS_uuid_re_PLUS_ = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/;
struct.core.uuid_str = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"message","message",-406056002),"must be an uuid",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__51606_SHARP_){
var and__3911__auto__ = typeof p1__51606_SHARP_ === 'string';
if(and__3911__auto__){
return cljs.core.re_seq.call(null,/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/,p1__51606_SHARP_);
} else {
return and__3911__auto__;
}
}),new cljs.core.Keyword(null,"coerce","coerce",1917884504),(function (p1__51608_SHARP_){
return struct.core.uuid.call(null,p1__51608_SHARP_);
})], null);
...
var and__3911__auto__ = typeof p1__51609_SHARP_ === 'string';
if(and__3911__auto__){
return cljs.core.re_seq.call(null,rx,p1__51609_SHARP_);
} else {
return and__3911__auto__;
}
});})(rx))
...
struct.core.required = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"this field is mandatory",new cljs.core.Keyword(null,"optional","optional",2053951509),false,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__51610_SHARP_){
if(typeof p1__51610_SHARP_ === 'string'){
return !(cljs.core.empty_QMARK_.call(null,p1__51610_SHARP_));
} else {
return !((p1__51610_SHARP_ == null));
}
})], null);
...
struct.core.number_str = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"message","message",-406056002),"must be a number",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__51611_SHARP_){
var or__3922__auto__ = typeof p1__51611_SHARP_ === 'number';
if(or__3922__auto__){
return or__3922__auto__;
} else {
var and__3911__auto__ = typeof p1__51611_SHARP_ === 'string';
if(and__3911__auto__){
return cuerdas.core.numeric_QMARK_.call(null,p1__51611_SHARP_);
} else {
return and__3911__auto__;
}
}
}),new cljs.core.Keyword(null,"coerce","coerce",1917884504),(function (p1__51612_SHARP_){
if(typeof p1__51612_SHARP_ === 'number'){
return p1__51612_SHARP_;
} else {
return cuerdas.core.parse_number.call(null,p1__51612_SHARP_);
}
})], null);
struct.core.integer = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"must be a integer",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__51613_SHARP_){
return Number.isInteger(p1__51613_SHARP_);
})], null);
struct.core.integer_str = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"message","message",-406056002),"must be a long",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__51615_SHARP_){
var or__3922__auto__ = typeof p1__51615_SHARP_ === 'number';
if(or__3922__auto__){
return or__3922__auto__;
} else {
var and__3911__auto__ = typeof p1__51615_SHARP_ === 'string';
if(and__3911__auto__){
return cuerdas.core.numeric_QMARK_.call(null,p1__51615_SHARP_);
} else {
return and__3911__auto__;
}
}
}),new cljs.core.Keyword(null,"coerce","coerce",1917884504),(function (p1__51616_SHARP_){
if(typeof p1__51616_SHARP_ === 'number'){
return (p1__51616_SHARP_ | (0));
} else {
return cuerdas.core.parse_int.call(null,p1__51616_SHARP_);
}
})], null);
struct.core.boolean$ = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"must be a boolean",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__51617_SHARP_){
return ((cljs.core._EQ_.call(null,false,p1__51617_SHARP_)) || (cljs.core._EQ_.call(null,true,p1__51617_SHARP_)));
})], null);
struct.core.boolean_str = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"message","message",-406056002),"must be a boolean",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__51618_SHARP_){
var and__3911__auto__ = typeof p1__51618_SHARP_ === 'string';
if(and__3911__auto__){
return cljs.core.re_seq.call(null,/^(?:t|true|false|f|0|1)$/,p1__51618_SHARP_);
} else {
return and__3911__auto__;
}
}),new cljs.core.Keyword(null,"coerce","coerce",1917884504),(function (p1__51619_SHARP_){
return cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, ["true",null,"t",null,"1",null], null), null),p1__51619_SHARP_);
})], null);
...
struct.core.every = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"must match the predicate",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__51624_SHARP_,p2__51623_SHARP_){
return cljs.core.every_QMARK_.call(null,p2__51623_SHARP_,p1__51624_SHARP_);
})], null);
struct.core.member = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),"not in coll",new cljs.core.Keyword(null,"optional","optional",2053951509),true,new cljs.core.Keyword(null,"validate","validate",-201300827),(function (p1__51625_SHARP_,p2__51626_SHARP_){
return cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([p1__51625_SHARP_]),p2__51626_SHARP_);
})], null);
...
//# sourceMappingURL=core.js.map?rel=1536503781534
