...
var len__4499__auto___48736 = arguments.length;
var i__4500__auto___48737 = (0);
while(true){
if((i__4500__auto___48737 < len__4499__auto___48736)){
args__4502__auto__.push((arguments[i__4500__auto___48737]));

var G__48738 = (i__4500__auto___48737 + (1));
i__4500__auto___48737 = G__48738;
continue;
} else {
}
break;
...
/** @this {Function} */
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq48735){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq48735));
});
...
var G__48741 = cljs.core.reduce.call(null,((function (text,state,matches,temp__5455__auto__){
return (function (s,r){
...
return cljs.core.get.call(null,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__48739_SHARP_,p1__48739_SHARP_);
});})(text,state,matches,temp__5455__auto__))
);
});})(text,state,matches,temp__5455__auto__))
,text,matches);
var G__48742 = cljs.core.update.call(null,state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5455__auto__){
return (function (p1__48740_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__48740_SHARP_,matches);
});})(text,state,matches,temp__5455__auto__))
);
text = G__48741;
state = G__48742;
...
var vec__48745 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__48748 = transformer.call(null,clojure.string.join.call(null,buf),cur_state);
var s = cljs.core.nth.call(null,vec__48748,(0),null);
var new_state = cljs.core.nth.call(null,vec__48748,(1),null);
...
var new_buf = cljs.core.nth.call(null,vec__48745,(0),null);
var new_state = cljs.core.nth.call(null,vec__48745,(1),null);
var G__48752 = cljs.core.vec.call(null,cljs.core.concat.call(null,out,cljs.core.seq.call(null,open),new_buf,cljs.core.seq.call(null,close)));
var G__48753 = cljs.core.PersistentVector.EMPTY;
var G__48754 = cljs.core.rest.call(null,tokens);
var G__48755 = cljs.core.assoc.call(null,new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__48752;
buf = G__48753;
tokens = G__48754;
cur_state = G__48755;
...
var G__48756 = out;
var G__48757 = cljs.core.into.call(null,buf,cljs.core.first.call(null,tokens));
var G__48758 = cljs.core.rest.call(null,tokens);
var G__48759 = cur_state;
out = G__48756;
buf = G__48757;
tokens = G__48758;
cur_state = G__48759;
...
var G__48760 = out;
var G__48761 = buf;
var G__48762 = cljs.core.rest.call(null,tokens);
var G__48763 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__48760;
buf = G__48761;
tokens = G__48762;
cur_state = G__48763;
...
var G__48764 = cljs.core.into.call(null,out,cljs.core.first.call(null,tokens));
var G__48765 = buf;
var G__48766 = cljs.core.rest.call(null,tokens);
var G__48767 = cur_state;
out = G__48764;
buf = G__48765;
tokens = G__48766;
cur_state = G__48767;
...
var num_hashes = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__48768_SHARP_){
return cljs.core.not_EQ_.call(null," ",p1__48768_SHARP_);
}),cljs.core.take_while.call(null,(function (p1__48769_SHARP_){
return ((cljs.core._EQ_.call(null,"#",p1__48769_SHARP_)) || (cljs.core._EQ_.call(null," ",p1__48769_SHARP_)));
...
//# sourceMappingURL=common.js.map?rel=1536503770983
