...
var len__4499__auto___53806 = arguments.length;
var i__4500__auto___53807 = (0);
while(true){
if((i__4500__auto___53807 < len__4499__auto___53806)){
args__4502__auto__.push((arguments[i__4500__auto___53807]));

var G__53808 = (i__4500__auto___53807 + (1));
i__4500__auto___53807 = G__53808;
continue;
} else {
}
break;
...
rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__53802){
var vec__53803 = p__53802;
var additional = cljs.core.nth.call(null,vec__53803,(0),null);
if(cljs.core.truth_(additional)){
return ((function (vec__53803,additional){
...
;})(vec__53803,additional))
} else {
return ((function (vec__53803,additional){
return (function (p1__53799_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__53799_SHARP_),t);
});
;})(vec__53803,additional))
}
});
...
/** @this {Function} */
rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq53800){
var G__53801 = cljs.core.first.call(null,seq53800);
var seq53800__$1 = cljs.core.next.call(null,seq53800);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53801,seq53800__$1);
});

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__53809,p__53810){
var map__53811 = p__53809;
...
var row = cljs.core.get.call(null,map__53811__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.call(null,map__53811__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.call(null,map__53811__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.call(null,map__53811__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__53812 = p__53810;
var map__53812__$1 = ((((!((map__53812 == null)))?(((((map__53812.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53812.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53812):map__53812);
var r = cljs.core.get.call(null,map__53812__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.call(null,map__53812__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last.call(null,cljs.core.filter.call(null,(function (p1__53818_SHARP_){
var and__3911__auto__ = p_QMARK_.call(null,p1__53818_SHARP_);
if(cljs.core.truth_(and__3911__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_.call(null,cljs.core.meta.call(null,clojure.zip.node.call(null,p1__53818_SHARP_)),pos);
} else {
return and__3911__auto__;
}
...
var G__53824 = zloc;
var G__53824__$1 = (((G__53824 == null))?null:f.call(null,G__53824));
if((G__53824__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.call(null,G__53824__$1,f,p_QMARK_);
}
});
...
return rewrite_clj.zip.findz.find.call(null,zloc,f,(function (p1__53826_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__53826_SHARP_),t);
}));
});
...
return rewrite_clj.zip.findz.find_last_by_pos.call(null,zloc,pos,(function (p1__53833_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__53833_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_.call(null,v))?cljs.core.comp.call(null,v,rewrite_clj.zip.base.sexpr):(function (p1__53840_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.sexpr.call(null,p1__53840_SHARP_),v);
}));
...
//# sourceMappingURL=findz.js.map?rel=1536503795864
