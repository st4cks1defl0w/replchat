...
var len__4499__auto___53857 = arguments.length;
var i__4500__auto___53858 = (0);
while(true){
if((i__4500__auto___53858 < len__4499__auto___53857)){
args__4502__auto__.push((arguments[i__4500__auto___53858]));

var G__53859 = (i__4500__auto___53858 + (1));
i__4500__auto___53858 = G__53859;
continue;
} else {
}
break;
...
return clojure.zip.edit.call(null,zloc,rewrite_clj.zip.editz.edit_node,(function (p1__53853_SHARP_){
return cljs.core.apply.call(null,f,p1__53853_SHARP_,args);
}));
});
...
/** @this {Function} */
rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq53854){
var G__53855 = cljs.core.first.call(null,seq53854);
var seq53854__$1 = cljs.core.next.call(null,seq53854);
var G__53856 = cljs.core.first.call(null,seq53854__$1);
var seq53854__$2 = cljs.core.next.call(null,seq53854__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53855,G__53856,seq53854__$2);
});
...
var G__53862 = rewrite_clj.zip.base.tag.call(null,zloc);
var G__53862__$1 = (((G__53862 instanceof cljs.core.Keyword))?G__53862.fqn:null);
switch (G__53862__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token.call(null,zloc,((function (G__53862,G__53862__$1){
return (function (p1__53860_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53860_SHARP_)].join('');
});})(G__53862,G__53862__$1))
);

break;
case "multi-line":
return rewrite_clj.zip.editz.edit_multi_line.call(null,zloc,((function (G__53862,G__53862__$1){
return (function (lines){
if(cljs.core.empty_QMARK_.call(null,lines)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null);
} else {
return cljs.core.update_in.call(null,lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),((function (G__53862,G__53862__$1){
return (function (p1__53861_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53861_SHARP_)].join('');
});})(G__53862,G__53862__$1))
);
}
});})(G__53862,G__53862__$1))
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53862__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__53865 = rewrite_clj.zip.base.tag.call(null,zloc);
var G__53865__$1 = (((G__53865 instanceof cljs.core.Keyword))?G__53865.fqn:null);
switch (G__53865__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token.call(null,zloc,((function (G__53865,G__53865__$1){
return (function (p1__53864_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53864_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
});})(G__53865,G__53865__$1))
);

break;
case "multi-line":
return rewrite_clj.zip.editz.edit_multi_line.call(null,zloc,((function (G__53865,G__53865__$1){
return (function (lines){
if(cljs.core.empty_QMARK_.call(null,lines)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null);
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53865__$1)].join('')));

}
});

//# sourceMappingURL=editz.js.map?rel=1536503796032
