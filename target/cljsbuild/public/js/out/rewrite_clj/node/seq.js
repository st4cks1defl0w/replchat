...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4174__auto__,k51860,else__4175__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k51860,else__4175__auto__);
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__51859){
var self__ = this;
var G__51859__$1 = this;
return (new cljs.core.RecordIter((0),G__51859__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this51861,other51862){
var self__ = this;
var this51861__$1 = this;
return ((!((other51862 == null))) && ((this51861__$1.constructor === other51862.constructor)) && (cljs.core._EQ_.call(null,this51861__$1.tag,other51862.tag)) && (cljs.core._EQ_.call(null,this51861__$1.wrap_fn,other51862.wrap_fn)) && (cljs.core._EQ_.call(null,this51861__$1.wrap_length,other51862.wrap_length)) && (cljs.core._EQ_.call(null,this51861__$1.seq_fn,other51862.seq_fn)) && (cljs.core._EQ_.call(null,this51861__$1.children,other51862.children)) && (cljs.core._EQ_.call(null,this51861__$1.__extmap,other51862.__extmap)));
});
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4179__auto__,k__4180__auto__,G__51859){
var self__ = this;
var this__4179__auto____$1 = this;
var pred__51865 = cljs.core.keyword_identical_QMARK_;
var expr__51866 = k__4180__auto__;
if(cljs.core.truth_(pred__51865.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__51866))){
return (new rewrite_clj.node.seq.SeqNode(G__51859,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__51865.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__51866))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__51859,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__51865.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__51866))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__51859,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__51865.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__51866))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__51859,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__51865.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__51866))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__51859,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4180__auto__,G__51859),null));
}
}
}
}
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4171__auto__,G__51859){
var self__ = this;
var this__4171__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__51859,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__51863){
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__51863),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__51863),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__51863),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__51863),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__51863),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__51863,new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982))),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode.call(null,new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__51869_SHARP_){
return cljs.core.apply.call(null,cljs.core.list,p1__51869_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode.call(null,new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__51870_SHARP_){
return cljs.core.apply.call(null,cljs.core.hash_map,p1__51870_SHARP_);
}),children);
});

//# sourceMappingURL=seq.js.map?rel=1536503784650
