...
rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4174__auto__,k51993,else__4175__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k51993,else__4175__auto__);
...
rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__51992){
var self__ = this;
var G__51992__$1 = this;
return (new cljs.core.RecordIter((0),G__51992__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this51994,other51995){
var self__ = this;
var this51994__$1 = this;
return ((!((other51995 == null))) && ((this51994__$1.constructor === other51995.constructor)) && (cljs.core._EQ_.call(null,this51994__$1.children,other51995.children)) && (cljs.core._EQ_.call(null,this51994__$1.__extmap,other51995.__extmap)));
});
...
rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4179__auto__,k__4180__auto__,G__51992){
var self__ = this;
var this__4179__auto____$1 = this;
var pred__51998 = cljs.core.keyword_identical_QMARK_;
var expr__51999 = k__4180__auto__;
if(cljs.core.truth_(pred__51998.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__51999))){
return (new rewrite_clj.node.forms.FormsNode(G__51992,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4180__auto__,G__51992),null));
}
});
...
rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4171__auto__,G__51992){
var self__ = this;
var this__4171__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__51992,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__51996){
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__51996),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__51996,new cljs.core.Keyword(null,"children","children",-940561982))),null));
});
...
//# sourceMappingURL=forms.js.map?rel=1536503785972
