...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__52028_SHARP_){
var _STAR_delimiter_STAR_52029 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = delimiter;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__52028_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR_52029;
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__4502__auto__ = [];
var len__4499__auto___52038 = arguments.length;
var i__4500__auto___52039 = (0);
while(true){
if((i__4500__auto___52039 < len__4499__auto___52038)){
args__4502__auto__.push((arguments[i__4500__auto___52039]));

var G__52040 = (i__4500__auto___52039 + (1));
i__4500__auto___52039 = G__52040;
continue;
} else {
}
break;
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__52034){
var vec__52035 = p__52034;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__52035,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq52030){
var G__52031 = cljs.core.first.call(null,seq52030);
var seq52030__$1 = cljs.core.next.call(null,seq52030);
var G__52032 = cljs.core.first.call(null,seq52030__$1);
var seq52030__$2 = cljs.core.next.call(null,seq52030__$1);
var G__52033 = cljs.core.first.call(null,seq52030__$2);
var seq52030__$3 = cljs.core.next.call(null,seq52030__$2);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52031,G__52032,G__52033,seq52030__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__52041 = rewrite_clj.reader.peek.call(null,reader);
switch (G__52041) {
case "(":
...
var G__52043 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__52043)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"{",G__52043)){
...
if(cljs.core._EQ_.call(null,"_",G__52043)){
...
//# sourceMappingURL=core.js.map?rel=1536503786278
