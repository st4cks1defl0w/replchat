...
var G__43993 = o;
(G__43993[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__43994__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__43994 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__43995__i = 0, G__43995__a = new Array(arguments.length -  0);
while (G__43995__i < G__43995__a.length) {G__43995__a[G__43995__i] = arguments[G__43995__i + 0]; ++G__43995__i;}
  args = new cljs.core.IndexedSeq(G__43995__a,0,null);
} 
return G__43994__delegate.call(this,args);};
G__43994.cljs$lang$maxFixedArity = 0;
G__43994.cljs$lang$applyTo = (function (arglist__43996){
var args = cljs.core.seq(arglist__43996);
return G__43994__delegate(args);
});
...
var G__43997 = o;
(G__43997[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__44002 = props;
var G__44002__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__44002,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__44002);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__44002__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__44003){
...
var props = map__44004__$1;
var class$ = cljs.core.get.call(null,map__44004__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__44004,map__44004__$1,props,class$){
return (function (c){
...
});})(map__44004,map__44004__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__44006){
...
var on_write = cljs.core.get.call(null,map__44007__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__44007,map__44007__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__44007,map__44007__$1,on_write))
);
} else {
...
var G__44010 = jsprops;
(G__44010["defaultValue"] = value);

(G__44010["onChange"] = ((function (G__44010,v,value,on_change){
return (function (p1__44009_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__44009_SHARP_);
});})(G__44010,v,value,on_change))
);
...
var vec__44013 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__44013,(0),null);
var id = cljs.core.nth.call(null,vec__44013,(1),null);
var class$ = cljs.core.nth.call(null,vec__44013,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___44017 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___44017 == null)){
} else {
var key_44018 = temp__5461__auto___44017;
(jsprops["key"] = key_44018);
}
...
var temp__5461__auto___44019 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___44019 == null)){
} else {
var key_44020 = temp__5461__auto___44019;
reagent.impl.template.oset.call(null,jsprops,"key",key_44020);
}
...
var G__44021 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__44021["name"] = c);
...
var len__4499__auto___44026 = arguments.length;
var i__4500__auto___44027 = (0);
while(true){
if((i__4500__auto___44027 < len__4499__auto___44026)){
args__4502__auto__.push((arguments[i__4500__auto___44027]));

var G__44028 = (i__4500__auto___44027 + (1));
i__4500__auto___44027 = G__44028;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq44024){
var G__44025 = cljs.core.first.call(null,seq44024);
var seq44024__$1 = cljs.core.next.call(null,seq44024);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44025,seq44024__$1);
});
...
break;
default:
var G__44031 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__44031;
continue;
...
var n__4376__auto___44033 = a.length;
var i_44034 = (0);
while(true){
if((i_44034 < n__4376__auto___44033)){
(a[i_44034] = reagent.impl.template.as_element.call(null,(a[i_44034])));

var G__44035 = (i_44034 + (1));
i_44034 = G__44035;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___44036 = a.length;
var i_44037 = (0);
while(true){
if((i_44037 < n__4376__auto___44036)){
var val_44038 = (a[i_44037]);
if(((cljs.core.vector_QMARK_.call(null,val_44038)) && ((reagent.impl.template.key_from_vec.call(null,val_44038) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_44037] = reagent.impl.template.as_element.call(null,val_44038));

var G__44039 = (i_44037 + (1));
i_44037 = G__44039;
continue;
} else {
}
...
var ctx = ({});
var vec__44040 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__44040,(0),null);
var derefed = cljs.core.nth.call(null,vec__44040,(1),null);
...
var G__44043 = (cljs.core.count.call(null,argv) - first_child);
switch (G__44043) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__44043){
...
//# sourceMappingURL=template.js.map?rel=1536503754630
