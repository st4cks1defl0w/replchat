...
return cljs.core.filter.call(null,(function (p1__54532_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__54532_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__54532_SHARP_) <= ending)));
}));
});
...
var G__54533 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return cljs.core._EQ_.call(null,new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__54535_SHARP_);
});})(and__3911__auto__))
...
return cljs.core.assoc_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some.call(null,(function (p1__54536_SHARP_){
return cljs.core._EQ_.call(null,app_db_id,p1__54536_SHARP_);
...
})),cljs.core.map.call(null,(function (p__54537){
...
var new_state = (function (){var G__54541 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.call(null,state,reaction_id,((function (G__54541,G__54541__$1,tags,reaction_id,state){
...
});})(G__54541,G__54541__$1,tags,reaction_id,state))
);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__54541__$1)].join('')));
...
return (function (all_state,p__54542){
var vec__54543 = p__54542;
var sub_id = cljs.core.nth.call(null,vec__54543,(0),null);
var sub_state = cljs.core.nth.call(null,vec__54543,(1),null);
...
//# sourceMappingURL=metamorphic.js.map?rel=1536503801451
