...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__56322){
var map__56323 = p__56322;
var map__56323__$1 = ((((!((map__56323 == null)))?(((((map__56323.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56323.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56323):map__56323);
var title = cljs.core.get.call(null,map__56323__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.call(null,map__56323__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.call(null,map__56323__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.call(null,map__56323__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.call(null,map__56323__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
var val = mranderson048.reagent.v0v8v0.reagent.core.atom.call(null,title);
var save = ((function (val,map__56323,map__56323__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
...
day8.re_frame_10x.view.components.autoscroll_list = (function day8$re_frame_10x$view$components$autoscroll_list(p__56327,child){
var map__56328 = p__56327;
var map__56328__$1 = ((((!((map__56328 == null)))?(((((map__56328.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56328.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56328):map__56328);
var class$ = cljs.core.get.call(null,map__56328__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var scroll_QMARK_ = cljs.core.get.call(null,map__56328__$1,new cljs.core.Keyword(null,"scroll?","scroll?",-1393045951));
...
return mranderson048.reagent.v0v8v0.reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"display-name","display-name",694513143),"autoscroll-list",new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (node,should_scroll,map__56328,map__56328__$1,class$,scroll_QMARK_){
return (function (_){
...
});})(node,should_scroll,map__56328,map__56328__$1,class$,scroll_QMARK_))
,new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),((function (node,should_scroll,map__56328,map__56328__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (node,should_scroll,map__56328,map__56328__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (node,should_scroll,map__56328,map__56328__$1,class$,scroll_QMARK_){
return (function (p__56330,child__$1){
var map__56331 = p__56330;
var map__56331__$1 = ((((!((map__56331 == null)))?(((((map__56331.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56331.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56331):map__56331);
var class$__$1 = cljs.core.get.call(null,map__56331__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),class$__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),((function (map__56331,map__56331__$1,class$__$1,node,should_scroll,map__56328,map__56328__$1,class$,scroll_QMARK_){
return (function (dom_node){
return cljs.core.reset_BANG_.call(null,node,dom_node);
});})(map__56331,map__56331__$1,class$__$1,node,should_scroll,map__56328,map__56328__$1,class$,scroll_QMARK_))
], null),child__$1], null);
});})(node,should_scroll,map__56328,map__56328__$1,class$,scroll_QMARK_))
], null));
});
...
return cljs.core.reduce.call(null,(function (acc,p__56334){
var vec__56335 = p__56334;
var property = cljs.core.nth.call(null,vec__56335,(0),null);
var value = cljs.core.nth.call(null,vec__56335,(1),null);
return cljs.core.assoc.call(null,acc,cljs.core.keyword.call(null,property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__56333_SHARP_){
return clojure.string.split.call(null,p1__56333_SHARP_,/:/);
...
var len__4499__auto___56340 = arguments.length;
var i__4500__auto___56341 = (0);
while(true){
if((i__4500__auto___56341 < len__4499__auto___56340)){
args__4502__auto__.push((arguments[i__4500__auto___56341]));

var G__56342 = (i__4500__auto___56341 + (1));
i__4500__auto___56341 = G__56342;
continue;
} else {
}
break;
...
var previous_config__56311__auto__ = devtools.prefs.get_prefs.call(null);
var prefs__56312__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_.call(null,prefs__56312__auto__);

return cljs.core.apply.call(null,api_fn,args);
}finally {if(cljs.core._EQ_.call(null,devtools.prefs.get_prefs.call(null),prefs__56312__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__56312__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_.call(null,previous_config__56311__auto__);
}});

day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1);

/** @this {Function} */
day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq56338){
var G__56339 = cljs.core.first.call(null,seq56338);
var seq56338__$1 = cljs.core.next.call(null,seq56338);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56339,seq56338__$1);
});
...
var args__4502__auto__ = [];
var len__4499__auto___56344 = arguments.length;
var i__4500__auto___56345 = (0);
while(true){
if((i__4500__auto___56345 < len__4499__auto___56344)){
args__4502__auto__.push((arguments[i__4500__auto___56345]));

var G__56346 = (i__4500__auto___56345 + (1));
i__4500__auto___56345 = G__56346;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq56343){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq56343));
});
...
var args__4502__auto__ = [];
var len__4499__auto___56348 = arguments.length;
var i__4500__auto___56349 = (0);
while(true){
if((i__4500__auto___56349 < len__4499__auto___56348)){
args__4502__auto__.push((arguments[i__4500__auto___56349]));

var G__56350 = (i__4500__auto___56349 + (1));
i__4500__auto___56349 = G__56350;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_body.cljs$lang$applyTo = (function (seq56347){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq56347));
});
...
var args__4502__auto__ = [];
var len__4499__auto___56352 = arguments.length;
var i__4500__auto___56353 = (0);
while(true){
if((i__4500__auto___56353 < len__4499__auto___56352)){
args__4502__auto__.push((arguments[i__4500__auto___56353]));

var G__56354 = (i__4500__auto___56353 + (1));
i__4500__auto___56353 = G__56354;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq56351){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq56351));
});
...
var vec__56355 = jsonml;
var seq__56356 = cljs.core.seq.call(null,vec__56355);
var first__56357 = cljs.core.first.call(null,seq__56356);
var seq__56356__$1 = cljs.core.next.call(null,seq__56356);
var tag_name = first__56357;
var first__56357__$1 = cljs.core.first.call(null,seq__56356__$1);
var seq__56356__$2 = cljs.core.next.call(null,seq__56356__$1);
var attributes = first__56357__$1;
...
var args__4502__auto__ = [];
var len__4499__auto___56365 = arguments.length;
var i__4500__auto___56366 = (0);
while(true){
if((i__4500__auto___56366 < len__4499__auto___56365)){
args__4502__auto__.push((arguments[i__4500__auto___56366]));

var G__56367 = (i__4500__auto___56366 + (1));
i__4500__auto___56366 = G__56367;
continue;
} else {
}
break;
...
day8.re_frame_10x.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__56361){
var vec__56362 = p__56361;
var class$ = cljs.core.nth.call(null,vec__56362,(0),null);
var expanded_QMARK_ = mranderson048.reagent.v0v8v0.reagent.core.atom.call(null,true);
return ((function (expanded_QMARK_,vec__56362,class$){
return (function (data__$1){
...
;})(expanded_QMARK_,vec__56362,class$))
});

day8.re_frame_10x.view.components.simple_render.cljs$lang$maxFixedArity = (2);

/** @this {Function} */
day8.re_frame_10x.view.components.simple_render.cljs$lang$applyTo = (function (seq56358){
var G__56359 = cljs.core.first.call(null,seq56358);
var seq56358__$1 = cljs.core.next.call(null,seq56358);
var G__56360 = cljs.core.first.call(null,seq56358__$1);
var seq56358__$2 = cljs.core.next.call(null,seq56358__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56359,G__56360,seq56358__$2);
});
...
//# sourceMappingURL=components.js.map?rel=1536503806977
