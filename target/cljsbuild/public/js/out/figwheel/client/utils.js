...
return (new CustomEvent(event_name,(function (){var obj60215 = {"detail":data};
return obj60215;
})()));
} else {
...
var f = (function (){var pred__60222 = cljs.core._EQ_;
var expr__60223 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__60222.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__60223))){
return ((function (pred__60222,expr__60223){
return (function (p1__60216_SHARP_){
return console.warn(p1__60216_SHARP_);
});
;})(pred__60222,expr__60223))
} else {
if(cljs.core.truth_(pred__60222.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__60223))){
return ((function (pred__60222,expr__60223){
return (function (p1__60217_SHARP_){
return console.debug(p1__60217_SHARP_);
});
;})(pred__60222,expr__60223))
} else {
if(cljs.core.truth_(pred__60222.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__60223))){
return ((function (pred__60222,expr__60223){
return (function (p1__60218_SHARP_){
return console.error(p1__60218_SHARP_);
});
;})(pred__60222,expr__60223))
} else {
return ((function (pred__60222,expr__60223){
return (function (p1__60219_SHARP_){
return console.log(p1__60219_SHARP_);
});
;})(pred__60222,expr__60223))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__60226){
var map__60227 = p__60226;
var map__60227__$1 = ((((!((map__60227 == null)))?(((((map__60227.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__60227.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__60227):map__60227);
var opts = map__60227__$1;
var eval_fn = cljs.core.get.call(null,map__60227__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__60229_SHARP_);
});})(new_def))
);
...
return (function (p__60230){
var vec__60231 = p__60230;
var ky = cljs.core.nth.call(null,vec__60231,(0),null);
var v = cljs.core.nth.call(null,vec__60231,(1),null);
...
}catch (e60236){if((e60236 instanceof Error)){
var e = e60236;
return not_found;
} else {
throw e60236;
...
//# sourceMappingURL=utils.js.map?rel=1536503812865
