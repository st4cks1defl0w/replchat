...
if((i < len)){
var k = (ks[i]);
var G__5110 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__5111 = (i + (1));
m = G__5110;
i = G__5111;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__5113 = c;
var G__5113__$1 = (((G__5113 == null))?null:G__5113.prototype);
if((G__5113__$1 == null)){
return null;
} else {
return (G__5113__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__5115 = c;
var G__5115__$1 = (((G__5115 == null))?null:G__5115.prototype);
if((G__5115__$1 == null)){
return null;
} else {
return (G__5115__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__5118__delegate = function (args){
return reagent.impl.component.as_element.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__5118 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__5119__i = 0, G__5119__a = new Array(arguments.length -  0);
while (G__5119__i < G__5119__a.length) {G__5119__a[G__5119__i] = arguments[G__5119__i + 0]; ++G__5119__i;}
  args = new cljs.core.IndexedSeq(G__5119__a,0,null);
} 
return G__5118__delegate.call(this,args);};
G__5118.cljs$lang$maxFixedArity = 0;
G__5118.cljs$lang$applyTo = (function (arglist__5120){
var args = cljs.core.seq(arglist__5120);
return G__5118__delegate(args);
});
...
var _STAR_current_component_STAR_5122 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_5122;
}});
...
return ((function (G__5123,G__5123__$1){
...
var c = this;
var G__5128_5130 = (c["cljsRatom"]);
if((G__5128_5130 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__5128_5130);
}
...
var renders_5132 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_5133 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_5132));
if((cljs.core.count.call(null,renders_5132) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_5132))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_5133)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_5133))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__5131 = name;
switch (G__5131) {
case "":
...
var G__5135 = o;
(G__5135[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__5136 = fiber;
var G__5136__$1 = (((G__5136 == null))?null:(G__5136["type"]));
if((G__5136__$1 == null)){
return null;
} else {
return (G__5136__$1["displayName"]);
}
})();
var parent = (function (){var G__5137 = fiber;
if((G__5137 == null)){
return null;
} else {
return (G__5137["return"]);
}
})();
var path = (function (){var G__5138 = parent;
var G__5138__$1 = (((G__5138 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__5138));
if((G__5138__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5138__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__5140 = c;
if((G__5140 == null)){
return null;
} else {
return (G__5140["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__5141._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__5143 = c;
if((G__5143 == null)){
return null;
} else {
return (G__5143["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__5145 = c;
if((G__5145 == null)){
return null;
} else {
return G__5145._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__5147 = instance;
if((G__5147 == null)){
return null;
} else {
return (G__5147["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__5148 = instance;
if((G__5148 == null)){
return null;
} else {
return G__5148._currentElement;
}
}
})();
var name = (function (){var G__5149 = elem;
var G__5149__$1 = (((G__5149 == null))?null:(G__5149["type"]));
if((G__5149__$1 == null)){
return null;
} else {
return (G__5149__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__5151 = elem;
if((G__5151 == null)){
return null;
} else {
return (G__5151["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__5152._owner;
}
}
})();
var path = (function (){var G__5153 = owner;
var G__5153__$1 = (((G__5153 == null))?null:reagent.impl.component.component_path.call(null,G__5153));
if((G__5153__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5153__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__5154 = c;
var G__5154__$1 = (((G__5154 == null))?null:G__5154.constructor);
if((G__5154__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__5154__$1);
}
}
})();
