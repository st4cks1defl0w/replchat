...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__5328 = cljs.core.instance_QMARK_;
var expr__5329 = reactive_val;
if(cljs.core.truth_(pred__5328.call(null,reagent.ratom.RAtom,expr__5329))){
return "ra";
} else {
if(cljs.core.truth_(pred__5328.call(null,reagent.ratom.RCursor,expr__5329))){
return "rc";
} else {
if(cljs.core.truth_(pred__5328.call(null,reagent.ratom.Reaction,expr__5329))){
return "rx";
} else {
if(cljs.core.truth_(pred__5328.call(null,reagent.ratom.Track,expr__5329))){
return "tr";
} else {
return "other";
}
